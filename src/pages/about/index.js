...
import aboutMePhoto from "assets/josemaria.jpg";

export default function About() {
  return (
    <ModelPost coverPhoto={coverPhoto} title="About Me">
      <h3 className={styles.subtitle}>Olá, sou o José</h3>
      <img
        src={aboutMePhoto}
        alt="Foto de José Maria"
